function [selected_channels, lambda] = do_lasso(params, A, b)
            ...
            if(length(selected_channels)==params.lassochnum)
                ...
                if(length(uniq_chnls)~=(params.lassochnum*2))
                        ...
                        if(~isempty(r))
                            ...
                            p11 = length(b)/nofchannels *ones(nofchannels,1); %each of the channels represents a group with length equal to number of delays
